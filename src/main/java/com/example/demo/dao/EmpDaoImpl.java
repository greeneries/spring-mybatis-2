...
public class EmpDaoImpl implements EmpDao {
	...
	@Override
	public List<Emp> search(Map<String, String> emp) {
		...
		return session.selectList("com.example.demo.dao.EmpDao.search", emp);
	}
	...
	public List<Emp> findByPageSizeUsingBind(int page, int size) {
		...
		return session
				.selectList(
						"com.example.demo.dao.EmpDao.findByPageSizeUsingBind", 
						map);
